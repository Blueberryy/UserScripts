// ==UserScript==
// @name              GreasyFork Notification Assistant
...
// @name:ru           GreasyFork: помощник уведомлений
// @description:ru    При появлении нового ответа на ваш скрипт или на обсуждение, в котором вы участвуете, скрипт будет отображать последнее содержимое обсуждения в модальном окне на веб-странице.
...
// @description       When there’s a new reply to your script or to a discussion you’re participating in, the script will display the latest discussion content in a modal window on the web page.
    ...
    const translate = (function () {
        ...
        const strings = {
            'en': {
                ...
                ScriptsDiscussions: 'Scripts Discussions',
                Discussions: 'Discussions',
                title: 'GreasyFork Notification Assistant Settings',
                saveBtn: 'Save',
                cancelBtn: 'Cancel'
            }, 'zh-CN': {
                reversal: '反转通知信息：',
                ...
                reversal: 'Обратные уведомления：',
                loadingquantity: 'Число загруженных обсуждений:',
                popup: 'Время появления:',
                Save: 'Сохранённые обсуждения:',
                Setoptions: 'Задать параметры',
                ScriptsDiscussions: 'Обсуждения скриптов',
                Discussions: 'Обсуждения',
                title: 'Настройки помощника уведомлений GreasyFork',
                saveBtn: 'Сохранить',
                cancelBtn: 'Отмена'
            }
        }
